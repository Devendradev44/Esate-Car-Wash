    ...
    <div className="flex min-h-screen flex-col bg-canvas pb-24">
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        <Dialog open={!!cancelModal.booking} onOpenChange={(open) => { if (!open) setCancelModal({ booking: null, mode: 'confirm' }); }}>
          <DialogContent className="max-h-[90vh] overflow-y-auto gap-0 rounded-lg border border-hairline bg-surface-soft p-6 ring-0 sm:max-w-md">
            {cancelModal.booking && (cancelModal.mode === 'confirm' ? (
              <div className="space-y-4">
                <DialogTitle className="text-xl font-bold text-ink">Cancel Booking?</DialogTitle>
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    className="flex-1 h-auto rounded-lg bg-yellow-dark py-3 text-sm font-bold text-black hover:bg-yellow-light"
                  >
                    Reschedule
                  </Button>
                  <Button
                    onClick={handleConfirmCancel}
                    className="flex-1 h-auto rounded-lg bg-m-red py-3 text-sm font-bold text-ink hover:bg-m-red/80"
                  >
                    Cancel Booking
                  </Button>
                </div>
              ...
              <div className="space-y-4">
                <DialogTitle className="text-xl font-bold text-ink">Reschedule Booking</DialogTitle>
                ...
                <div>
                  ...
                  <Input
                    ...
                    min={getTodayDate()}
                    className="w-full h-auto rounded-lg border border-hairline bg-surface-card p-3 text-sm font-light text-ink focus:border-yellow-dark focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <Select value={rescheduleTime || null} onValueChange={(v) => setRescheduleTime(v || "")}>
                    <SelectTrigger className="w-full h-auto! rounded-lg border border-hairline bg-surface-card p-3 text-sm font-light text-ink focus:border-yellow-dark focus:outline-none">
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    className="flex-1 h-auto rounded-lg border border-hairline py-3 text-sm font-bold text-body hover:bg-surface-elevated hover:text-body"
                  >
                    Back
                  </Button>
                  <Button
                    ...
                    className="flex-1 h-auto rounded-lg bg-yellow-dark py-3 text-sm font-bold text-black hover:bg-yellow-light disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Confirm Reschedule
                  </Button>
                </div>
